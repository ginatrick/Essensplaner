...
- [ ] Prospekt-PDF-Pipeline mit Haiku *(Lidl+Kaufland von Codex umgesetzt nach `codex/006-prospekt-schwarz-leaflets.md`, live gegen echte Discovery+PDF-Download geprüft — Haiku-Extraktion nur gegen Fixtures getestet, kein `ANTHROPIC_API_KEY` in der Dev-Sandbox verfügbar für einen echten Live-Call. Aldi+Norma (`codex/007-prospekt-aldi-norma.md`, kein Haiku) noch offen. EDEKA/Netto blocken aktiv, zurückgestellt, siehe docs/06)*
