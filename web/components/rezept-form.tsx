...
const emptyValues: RecipeFormValues = { title: "", source_url: "", servings_base: 4, prep_min: null, cook_min: null, difficulty: null, tags: [], kid_friendly: false, is_experimental: false, steps: [""], ingredients: [{ amount: "", unit: "", name: "", note: null, ingredient_id: null }] };
